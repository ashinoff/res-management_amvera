// Инлайн SVG-иконки (lucide-стиль). Обводка наследует currentColor —
// цвет задаётся через color у обёртки. Без внешних зависимостей.
...
export const IconPlug = (p) => (
  <Svg {...p}>
    <path d="M12 22v-5" /><path d="M9 8V2" /><path d="M15 8V2" /><path d="M18 8v4a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V8z" />
  </Svg>
);
...
export const IconBroom = (p) => (
  <Svg {...p}>
    <path d="M19.4 5.6 14 11" /><path d="M9 13l-5 5" />
